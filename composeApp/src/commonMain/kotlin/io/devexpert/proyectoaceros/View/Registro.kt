...
@Composable
fun MainRegistro (navController : Navigation) {
    Registro(navController)
}

@Composable
fun Registro (navController : Navigation) {
    ...
    Column (modifier = Modifier
        ...
        OutlinedTextField(
            ...
            label = { Text("Nombre de usuario", textAlign = TextAlign.Center) },
            shape = RoundedCornerShape(5.dp),
            leadingIcon = { Icon(Icons.Default.Person, contentDescription = "Nombre Usuario", tint = Theme.primaryColor) },
            modifier = Modifier
                .fillMaxWidth(),
            colors = TextFieldDefaults.colors(
                focusedTextColor = Theme.primaryColor,
        ...
        OutlinedTextField(
            ...
            label = { Text("Nivel", textAlign = TextAlign.Center) },
            shape = RoundedCornerShape(5.dp),
            leadingIcon = { Icon(Icons.Default.Face, contentDescription = "Nivel", tint = Theme.primaryColor) },
            modifier = Modifier
                .fillMaxWidth(),
            colors = TextFieldDefaults.colors(
                focusedTextColor = Theme.primaryColor,
